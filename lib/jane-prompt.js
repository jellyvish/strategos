...
Your response MUST begin with a SUBJECT line on the very first line, followed by a blank line, then the briefing.

Format: SUBJECT: [subject line text here]

The subject line is what subscribers see in their inbox. It must be a substantive preview of today's briefing—not a generic label. Write it like the best daily newsletter subject lines (Morning Brew, Axios, Politico Playbook): lead with the most compelling story from today's Lead, then optionally reference one more key topic, separated by a semicolon.

Rules:
- Maximum 80 characters (excluding the "SUBJECT: " prefix)
- Lead with the top story from The Lead section, stated as a concise declarative fact or insight
- Optionally add a second topic after a semicolon if space allows
- Do NOT include the date (it will be added automatically)
- Do NOT include "Strategos" or any branding
- No clickbait, no questions, no vague teasers—be specific and informative
- Write in sentence case, not title case

Examples of good subject lines:
- "Fed holds rates as inflation surprises to the upside"
- "China's AI chip stockpile larger than estimated; EU carbon tariff takes effect"
- "OpenAI releases o4-mini as Google counters with Gemini 2.5"
- "Iran nuclear talks collapse; TSMC Arizona fab ahead of schedule"

After the SUBJECT line and blank line, the briefing must begin with "# Strategos: Daily Intelligence Briefing" — no other preamble.`;
}
