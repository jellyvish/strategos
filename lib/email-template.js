...
export function markdownToEmailHtml(markdown, date, recipientEmail = '', preheader = '') {
...
<body style="font-family: Georgia, 'Times New Roman', serif; font-size: 16px; line-height: 1.7; color: #a1a1aa; margin: 0; padding: 0; background-color: #09090b;">${preheader ? `
